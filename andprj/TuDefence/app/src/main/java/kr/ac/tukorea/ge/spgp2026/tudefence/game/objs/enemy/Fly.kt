    ...
    SheetSprite(gctx, R.mipmap.galaga_flies, 2f), IRecyclable
{
    ...
    companion object {
        ...
        val path = PathParser.createPathFromPathData(
            "M0,900 " +
            "C42,858 242,758 250,650 " +
            "C258,542 33,358 50,250 " +
            "C67,142 250,0 350,0 " +
            "C450,0 633,142 650,250 " +
            "C667,358 425,542 450,650 " +
            "C475,758 683,900 800,900 " +
            "C917,900 1125,758 1150,650 " +
            "C1175,542 933,358 950,250 " +
            "C967,142 1150,0 1250,0 " +
            "C1350,0 1533,142 1550,250 " +
            "C1567,358 1342,542 1350,650 " +
            "C1358,758 1558,858 1600,900"
        )!!
