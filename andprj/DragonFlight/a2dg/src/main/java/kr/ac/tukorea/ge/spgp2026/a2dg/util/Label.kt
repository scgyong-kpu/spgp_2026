...
// Label 은 문자열을 그리는 가장 단순한 HUD 도구이다.
// Gauge 가 진행률을 그리는 공통 도구라면, Label 은 문자열을 그리는 공통 도구라고 보면 된다.
//
// Label 자신은 현재 score 나 wave 같은 상태를 저장하지 않고,
